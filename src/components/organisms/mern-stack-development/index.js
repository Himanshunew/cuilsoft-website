...
import {
  AdvancedReactJsData,
  ExpressJsData,
  MernStackDevelopmentIntroData,
  MongoDBData,
  NodeJsData,
  ReactJsFundamentalsData,
...
export const MernStackDevelopmentData = () => {
  return (
    <section>
            ...
            <div className="shadow-2 bg-white rounded-lg p-7">
              ...
              <div>
                ...
                <div className="mb-5">
                  ...
                  {MernStackDevelopmentIntroData.map((item, id) => {
                    return (
                      <IconText
                        key={id}
                        title={item.title}
              ...
              <div>
                ...
                {ReactJsFundamentalsData.map((item, id) => {
                  return (
                    <IconText
                      key={id}
                      title={item.text}
              ...
              <div>
                ...
                {AdvancedReactJsData.map((item, id) => {
                  return (
                    <IconText
                      key={id}
                      title={item.text}
