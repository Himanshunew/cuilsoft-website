...
import {
  JobHighLightsData,
  ReactDeveloperJobData,
  ReactDeveloperKeyResponsibilitiesData,
...
export const ReactDeveloperJob = () => {
  return (
    <section>
            ...
            <div className="shadow-2 bg-white rounded-lg p-7">
              ...
              <div>
                <div className="mb-5">
                  ...
                  {ReactDeveloperJobData.map((item, id) => {
                    return (
                      <IconText
                        key={id}
                        title={item.text}
                ...
                <div className="mb-5">
                  ...
                  {ReactDeveloperKeyResponsibilitiesData.map((item, id) => {
                    return (
                      <IconText
                        key={id}
                        title={item.text}
