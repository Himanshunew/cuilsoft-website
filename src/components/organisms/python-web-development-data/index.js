...
import {
  ...
  APITestingData,
  backendDjangoData,
  databaseFundamentalsData,
  frontendDevelopmentData,
  PythonDevelopmentIntroData,
  pythonFundamentalsData,
...
export const PythonWebDevelopmentData = () => {
  return (
    <section>
            ...
            <div className="shadow-2 bg-white rounded-lg p-7">
              ...
              <div>
                ...
                <div className="mb-5">
                  ...
                  {PythonDevelopmentIntroData.map((item, id) => {
                    return (
                      <IconText
                        key={id}
                        title={item.title}
                ...
                <div>
                  ...
                  {pythonFundamentalsData.map((item, id) => {
                    return (
                      <IconText
                        key={id}
                        title={item.text}
              ...
              <div>
                <CustomText size={"xs"} className="mt-6 mb-2 text-black">
                  Database basic fundamentals
                </CustomText>

                {databaseFundamentalsData.map((item, id) => {
                  return (
                    <IconText
                      key={id}
                      title={item.text}
              ...
              <div>
                <CustomText size={"xs"} className="mt-6 mb-2 text-black">
                  Front-End Basic Development
                </CustomText>
                {frontendDevelopmentData.map((item, id) => {
                  return (
                    <IconText
                      key={id}
                      title={item.text}
              ...
              <div>
                ...
                {APIintegrationData.map((item, id) => {
                  return (
                    <IconText
                      key={id}
                      title={item.text}
