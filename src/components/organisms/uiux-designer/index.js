...
import {
  uiuxDesignerIntroData,
  WebDesignFundamentalsData,
  HTMLCSSBasicsData,
            ...
            <div className="shadow-2 bg-white rounded-lg p-7">
              ...
              <div>
                ...
                <div className="mb-5">
                  ...
                  {uiuxDesignerIntroData.map((item, id) => {
                    return (
                      <IconText
                        key={id}
                        title={item.title}
                ...
                <div>
                  ...
                  {WebDesignFundamentalsData.map((item, id) => {
                    return (
                      <IconText
                        key={id}
                        title={item.text}
              ...
              <div>
                ...
                {ResponsiveDesignData.map((item, id) => {
                  return (
                    <IconText
                      key={id}
                      title={item.text}
