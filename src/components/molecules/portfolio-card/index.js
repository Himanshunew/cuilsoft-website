...
export  function PortfolioCard({ activeTab, tabs }) {
  return (
          ...
          >
            <div className="relative">
              ...
              <div className="absolute top-3 right-3">
                <span className="px-2 py-1 bg-secondary backdrop-blur-sm text-xs font-medium text-white rounded-full">
                  {project.category}
                </span>
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-primary font-medium mb-4 text-sm leading-relaxed">{project.description}</p>
              ...
              <div className="flex gap-3">
                <a
                  ...
                  className="flex items-center gap-1 text-black  transition-colors text-sm"
                  target="_blank"
